...
case "$CHART_NAME" in
  ai-tutor-service|worksheet-import-service|api-gateway|collaboration-service|email-service|game-adapter-service|keycloak|keyboard-app|keyboard-service|media-service|payment-service|registration-service|vocabulary-service|web-app) ;;
