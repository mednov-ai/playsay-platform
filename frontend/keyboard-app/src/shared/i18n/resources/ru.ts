export const ru = {
  ...
  scoreExplanation: {
    ...
    formula: "Балл = точность {{accuracyWeight}}% + скорость {{speedWeight}}% + ритм {{cadenceWeight}}%.",
    current: "В этом упражнении: точность {{accuracyScore}}%, скорость {{speedScore}}%, ритм {{cadenceScore}}%.",
