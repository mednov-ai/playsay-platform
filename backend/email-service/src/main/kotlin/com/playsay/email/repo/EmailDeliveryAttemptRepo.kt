...
interface EmailDeliveryAttemptRepo : JpaRepository<EmailDeliveryAttemptEntity, UUID>, JpaSpecificationExecutor<EmailDeliveryAttemptEntity> {
    ...
    @Lock(LockModeType.PESSIMISTIC_WRITE)
    @Query("select e from EmailDeliveryAttemptEntity e where e.id = :id")
    fun findLockedById(id: UUID): EmailDeliveryAttemptEntity?
}
