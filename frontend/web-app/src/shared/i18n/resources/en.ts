export const en = {
  ...
  profile: {
    ...
    passkeys: {
      ...
      description: "Manage your passkeys and fallback password directly in Honey School.",
      add: "Add passkey",
      addAnother: "Add another passkey",
      configure: "Set up a passkey",
      passwordTitle: "Password",
      passwordActive: "Available as a fallback sign-in method",
      passwordUnavailable: "No password is configured",
      ...
      deleteConfirm: "Delete “{{label}}”? Passkey sign-in from this device will stop working.",
      deleteConfirmAction: "Delete",
      refresh: "Refresh sign-in methods",
      loading: "Loading sign-in methods…",
      loadError: "Could not load sign-in methods.",
      renamed: "Passkey name saved.",
      renameError: "Could not rename the passkey.",
      deleted: "Passkey deleted.",
      deleteError: "Could not delete the passkey. Keep at least one sign-in method.",
      success: "Passkey added successfully.",
      cancelled: "Passkey setup was cancelled.",
      failed: "The passkey was not added. Please try again.",
  ...
  vocabulary: {
    ...
    lessonMenu: { label: "Vocabulary", open: "Open vocabulary",
      dialogTitle: "Lesson vocabulary",
      tabsLabel: "Vocabulary sections",
      add: "Add word", recent: "Recent words", practice: "Start practice", back: "Back to vocabulary actions", empty: "No words from this lesson yet.", loadFailed: "Could not load recent words.", reconnecting: "Reconnecting" },
  ...
  schedule: {
    ...
    messages: {
      ...
      linksManualCopy: "Select and copy the lesson links manually",
    ...
    manualCopy: {
      title: "Lesson links",
      subtitle: "The browser blocked automatic copying. The text is selected so you can copy it manually.",
      textLabel: "Links to copy",
      copyAgain: "Copy again",
      copied: "Copied",
      close: "Close lesson links",
    },
  },
  homework: {
    title: "Homework",
  ...
  materials: {
    ...
    blockEditor: {
      ...
      videoMetadataHint: "Use this only when YouTube cannot provide complete metadata automatically.",
      videoDuration: "Duration (m:ss)",
