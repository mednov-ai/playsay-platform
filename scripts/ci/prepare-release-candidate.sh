...
TARGET_ORDER="api-gateway ai-tutor-service worksheet-import-service vocabulary-service web-app game-adapter-service collaboration-service media-service payment-service registration-service email-service keyboard-service keyboard-app"
