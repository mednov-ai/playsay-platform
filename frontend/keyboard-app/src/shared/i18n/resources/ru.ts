export const ru = {
  ...
  trainerIntro: {
    ...
    body: "Вместо случайных слов тренажер дает частые сочетания букв. Пальцы запоминают их как готовые движения.",
    samplesLabel: "Примеры буквенных аккордов",
    samples: "th ing ст про ени",
    microcopy: "Это не бессмыслица: такие фрагменты постоянно встречаются в реальной печати.",
    start: "Открыть тренажер",
    startAria: "Открыть тренажер и начать подготовку",
    shortcut: "Space - открыть тренажер",
