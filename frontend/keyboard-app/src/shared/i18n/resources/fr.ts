...
export const fr: TranslationResource = {
  ...
  trainerIntro: {
    ...
    body: "Au lieu de mots aléatoires, le clavier propose des combinaisons fréquentes. Les doigts les apprennent comme des gestes prêts.",
    samplesLabel: "Exemples d'accords de lettres",
    samples: "th ing st pro eni",
    microcopy: "Ces fragments ne sont pas aléatoires : ils reviennent sans cesse dans la frappe réelle.",
    start: "Ouvrir le clavier",
    startAria: "Ouvrir le clavier et lancer la préparation",
    shortcut: "Espace ouvre le clavier",
